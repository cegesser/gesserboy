...
public:
    GesserBoy()
        ...
        : gboy("roms/Super Mario Land.gb")
        //: gboy("roms/Metroid II.gb")
        //: gboy("roms/Zelda.gb")
        //: gboy("roms/Star Wars.gb")
        //: gboy("roms/dmg-acid2.gb")
        //: gboy("roms/cpu_instrs.gb")
        //: gboy("roms/individual/01-special.gb") //passed
        //: gboy("roms/individual/02-interrupts.gb") //passed
        //: gboy("roms/individual/03-op sp,hl.gb") //passed
        ...
        //: gboy("roms/individual/11-op a,(hl).gb") //passed
    {
...
public:
    ...
    bool OnUserUpdate(float elapsed_time) override
    {
        ...
        {
            //std::this_thread::sleep_for(std::chrono::milliseconds(1000*int(target_frame_time-fAccumulatedTime)));
            return true;
        }
